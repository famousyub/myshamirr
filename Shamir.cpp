...
void operation(int S, int N, int K)
{
  ...
  ofstream MyFile("shamircpp.txt");
    ...
    MyFile<< "We can generate Secret from any of "
         << K << " Parts" << endl;
    ...
    if (M < K) {
        cout << "Points are less than threshold "
             << K << " Points Required" << endl;
                ...
                MyFile << "Points are less than threshold "
             << K << " Points Required" << endl;
    }
